        ...
        <>
          ...
          <div className="absolute right-0 top-12 z-30 w-80 max-w-[90vw] rounded-xl border border-border bg-card shadow-xl">
            <div className="border-b border-border p-3 flex items-center justify-between">
              ...
              <Link to="/notifications" onClick={() => setOpen(false)} className="text-xs text-primary hover:underline">Tümü</Link>
            </div>
                ...
                (data ?? []).map((n) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {!n.read_at && <span className="mt-1 inline-block h-2 w-2 rounded-full bg-blue-500" aria-hidden="true" />}
                    </div>
